...
% experiment at a REFERENCE SPEED OF 40 km/h.
%
...
%
% Companion script for the 100 km/h reference speed: run2down1upPEST100.m
...
for i = 1:numel(conditions)
    ...
    % Initial comparison offset (Delta v) in km/h for the 40 km/h block.
    currentDiff = 10;
...
% Run one 2-down/1-up + PEST staircase block for a single sound condition.
    ...
    speed_ref              = 40;   % fixed reference speed (km/h)
    ...
    % ---------- PEST-related state ----------
    minStepSize = 1;   % rule 1: after a reversal step is halved, but not below this
